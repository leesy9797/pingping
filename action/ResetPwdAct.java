...
public class ResetPwdAct implements Action {
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		request.setCharacterEncoding("utf-8");

		System.out.println("아아, 여기는 ResetPwdAct");
		...
		*/
		...
		ResetPwdSvc resetPwdSvc = new ResetPwdSvc();
		
		memberInfo = resetPwdSvc.resetPwd(uname, phone);
