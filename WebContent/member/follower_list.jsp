...
ArrayList<FollowInfo> followerList = (ArrayList<FollowInfo>)request.getAttribute("followerList");
%>
...
#follower { color:#2788ff; font-weight:bold; }
</style>
<div id="wrapper">
	<h2>팔로워 목록</h2>
	...
	<td colspan="2" align="center">
		<a href="follower_list.mem" id="follower">팔로워</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="following_list.mem">팔로잉</a>
	</td>
	</tr>
	<tr><td colspan="3" height="30"><hr /></td></tr>
	...
	// 팔로워 검색 결과가 있으면
		for (int i = 0 ; i < followerList.size() ; i++) {
			FollowInfo fi = followerList.get(i);
			// 해당 회원의 스크랩북 페이지로 이동
			String lnk = "<a href=\"\">";
	%>
	<tr>
	...
	<%	
		...
		out.println("<tr align='center'><th colspan='3'>팔로워가 없습니다.</th></tr>");
	}
	%>
	</table>
</div>
